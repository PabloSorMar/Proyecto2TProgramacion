...
public enum ListaArmas {
    ...
    /**
     * Constructor interno para definir las estadísticas de cada arma en el
     * catálogo.
     * 
     * @param nombre            Nombre visual del arma.
     * @param dañoBase          Daño bruto por impacto.
     * @param precision         Probabilidad de acierto.
     * @param esMelee           {@code true} si es cuerpo a cuerpo, {@code false} si
     *                          es a distancia.
     ...
     *
     * @return Un objeto de tipo {@link Arma} configurado y listo para su uso en
     *         combate.
     */
