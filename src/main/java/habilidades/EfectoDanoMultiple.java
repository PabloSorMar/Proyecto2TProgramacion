...
public class EfectoDanoMultiple extends Habilidades {
     ...
     */
    public EfectoDanoMultiple(String nombre, int cooldownBase, String efecto, String tipo, int precision, int num,
            int dano) {
     ...
     * @param dano         parametro.
     */
    public EfectoDanoMultiple(String nombre, int cooldownBase, String efecto, boolean aDistancia, String tipo,
            int num, int dano) {
