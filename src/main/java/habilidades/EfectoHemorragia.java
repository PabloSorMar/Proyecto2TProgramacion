...
/**
 * Efecto mecánico: Aplica sangrado (hemorragia) por un número determinado de
 * turnos.
 */
public class EfectoHemorragia extends Habilidades {
     ...
     * @param turnos       parametro.
     */
    public EfectoHemorragia(String nombre, int cooldownBase, String efecto, boolean aDistancia, String tipo,
            int turnos) {
