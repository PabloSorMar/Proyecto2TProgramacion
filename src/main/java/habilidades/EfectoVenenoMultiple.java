...
public class EfectoVenenoMultiple extends Habilidades {
     ...
     */
    public EfectoVenenoMultiple(String nombre, int cooldownBase, String efecto, String tipo, int precision, int num,
            int turnos) {
     ...
     * @param turnos       parametro.
     */
    public EfectoVenenoMultiple(String nombre, int cooldownBase, String efecto, boolean aDistancia, String tipo,
            int num, int turnos) {
