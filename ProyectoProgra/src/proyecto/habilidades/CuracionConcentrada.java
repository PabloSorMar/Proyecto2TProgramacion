...
public class CuracionConcentrada extends Habilidades{

    public CuracionConcentrada(String nombre, int cooldownBase, String efecto, boolean distancia, String tipo) {
