        ...
        switch (this) {
            case PSIQUICO:
                ...
                habs.add(new EfectoDanoPerforante("Explosión Psíquica", 5,
                        "Explosión mental que ignora protecciones físicas.", true, "ofensiva", 65));
                habs.add(new EfectoDanoArea("Honda de Energía", 4, "Explosión global que daña a todos los enemigos.",
                        true, "ofensiva", 30));
                habs.add(new DebufPrecisionIndividual("Alterar sentidos", 3,
                        "Confunde al enemigo disminuyendo su acierto en un -25% (2T).", true, "debuf"));
                break;
            case GUARDIA_IMPERIAL:
                habs.add(
                        new EfectoBufPrecision("Apuntar", 2, "Se toma un tiempo para apuntar mejor.", true, "buf", 20));
                ...
                habs.add(new EfectoAturdimiento("Culatazo", 3, "Golpea con la culata del arma (1T stun).", false,
                        "ofensiva", 20, 1));
                habs.add(
            ...
            case KASRKIN:
                ...
                habs.add(new EfectoEscudoInvulnerable("Valor Cadiano", 0,
                        "Mejora la reducción de daño por armadura en un +20% (2 turnos).", false, "buf"));
                habs.add(new RecargarArma("Maestría en Armas", 4,
                        "El personaje puede atacar sin gastar munición durante este turno.", false, "buf"));
                habs.add(new EfectoDanoPerforante("Granada Perforante", 4,
                        "Lanza una granada diseñada para atravesar blindajes.", true, "ofensiva", 50));
                break;
            case COMISARIO_KRIEG:
                habs.add(new EfectoBufVelocidad("Alentar", 4,
                        "Potencia el daño de todos los aliados en un +15% durante ese turno.", false, "buf", 30));
                habs.add(new EfectoBufPrecision("Tiro certero", 3,
                        "Un disparo con +30% de acierto y probabilidad de Crítico (Daño x2).", true, "ofensiva", 20));
                habs.add(new EfectoBufVelocidad("Nervio de acero", 3, "Aumenta la esquiva en +25% durante 2 turnos.",
                        false, "buf", 30));
                habs.add(new DiscursoDeMiedo());
                break;
            case SENTINEL:
                habs.add(new EfectoDanoMultiple("Disparo de repetición", 3, "Realiza varios disparos consecutivos.",
                        true, "ofensiva", 3, 20));
                habs.add(new EfectoCuracionSostenida("Reparación", 4,
                        "Efectos de reparación continua en el objetivo (3T).", true, "curacion", 3));
                habs.add(new EfectoDanoArea("Pisotón de Sentinel", 4, "El Sentinel aplasta el suelo dañando a todos.",
                        false, "ofensiva", 40));
                habs.add(
                        new EfectoBufPrecision("Apuntar", 2, "Se toma un tiempo para apuntar mejor.", true, "buf", 20));
                break;
            case TOROGRETE:
                habs.add(new EfectoEscudoInvulnerable("Muro Andante", 5,
                        "Se posiciona frente a un aliado; recibe el 100% de los ataques dirigidos a él (1T).", false,
                        "buf"));
                habs.add(new EfectoEscudoInvulnerable("Cubrirse", 3,
                        "Aumenta +30% la probabilidad de que los ataques den en armadura (2 turnos).", false, "buf"));
                habs.add(new EfectoDanoArea("Disparo Explosivo", 4,
                        "Munición que explota al impactar, dañando el área.", true, "ofensiva", 40));
                habs.add(new EfectoAturdimiento("Puñetazo", 2, "Un fuerte golpe que puede aturdir (1T).", false,
                        "ofensiva", 15, 1));
                break;
            case DISRUPTOR:
                habs.add(new EfectoDanoDirecto("Carga", 3, "Carga contra el enemigo infligiendo daño.", false,
                        "ofensiva", 40));
                habs.add(new EfectoDanoDirecto("Arpón de Brazo", 4, "Lanza un arpón desde el brazo mecánico.", true,
                        "ofensiva", 40));
                habs.add(
                        new EfectoBufPrecision("Apuntar", 2, "Se toma un tiempo para apuntar mejor.", true, "buf", 20));
            ...
            case SACERDOTE_SANGUINARIO:
                habs.add(new EfectoCuracionSostenida("Cirugía en Combate", 5, "Realiza curas rápidas que se mantienen.",
                        true, "curacion", 5));
                habs.add(new GolpeEjecutor("Eutanasia", 4, "Ejecuta a un objetivo con menos del 20% de salud", false,
                        "ofensiva"));
                habs.add(new EfectoBufPrecision("Reconocimiento", 2,
                        "Aumenta la precisión de todo el equipo contra un objetivo", false, "buf", 20));
                habs.add(new EfectoDanoPerforante("Punto Débil", 3, "Apurta a los puntos débiles de la armadura.", true,
                        "ofensiva", 40));
                break;
            case BIBLIOTECARIO:
                habs.add(new EfectoEscudoInvulnerable("Barrera Psíquica", 5, "Genera un escudo de energía disforme.",
                ...
                break;
            case CORTACABEZAS:
                habs.add(new EfectoAturdimiento("Golpe con Escudo", 3, "Golpea con el escudo para aturdir al enemigo.",
                        false, "ofensiva", 15, 1));
                habs.add(new EfectoEscudoInvulnerable("Cubrirse", 3,
                        "Aumenta +30% la probabilidad de que los ataques den en armadura (2 turnos).", false, "buf"));
                habs.add(new EfectoDanoDirecto("Lanzamiento de Hacha", 2, "Lanza un hacha de combate (30 daño).", true,
                        "ofensiva", 30));
                habs.add(new EfectoDanoDirecto("Berserker", 5,
                        "Furia asesina que realiza un ataque devastador (50 daño).", false, "ofensiva", 50));
                break;
            case SAQUEADOR:
                habs.add(new EfectoBufVelocidad("Reflejos Relámpago", 3,
                        "Mejora los reflejos aumentando la velocidad (40).", true, "buf", 40));
                ...
                habs.add(new EfectoAturdimiento("Contusión", 4, "Provoca una fuerte contusión al enemigo.", false,
                        "ofensiva", 25, 1));
                break;
            case ALA_DE_MUERTE:
                habs.add(new EfectoDanoArea("Barrido", 3, "Realiza un barrido circular con el arma.", false, "ofensiva",
                        20));
                habs.add(new EfectoDanoArea("Andanada de Misiles", 5,
                        "Lluvia masiva de misiles sobre el campo de batalla.", true, "ofensiva", 50));
                habs.add(new EfectoEscudoInvulnerable("Muro Andante", 5,
                        "Se posiciona frente a un aliado; recibe el 100% de los ataques dirigidos a él (1T).", false,
                        "buf"));
