...
/**
     ...
     * @param faccion     El bando o grupo al que pertenece el héroe (ej. "Alianza", "Horda").
     ...
     * @param habilidades La lista de técnicas o poderes especiales disponibles para el héroe.
...
/**
     ...
     *
     * @param aliados    Una lista de objetos {@code Entidad} que forman parte del bando del Héroe.
     * @param enemigos   Una lista de objetos {@code Entidad} identificados como objetivos hostiles.
     * @param personaje  La instancia específica de la entidad que está ejecutando la acción 
